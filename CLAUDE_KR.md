...
4. **Claude**: [TODO.md](TODO.md)를 업데이트하여 완료된 항목을 체크하고 진행 상황 추적
5. **Claude**: Phase 완료 시 git commit 생성

[TODO.md](TODO.md)에 **[Gemini → Claude]**로 표시된 모든 코드 항목은 이 워크플로우를 따릅니다.

**중요**:
- 작업 또는 단계를 완료한 후 항상 TODO.md 체크리스트를 업데이트하여 현재 진행 상황을 반영하세요
- **각 Phase 완료 시 설명적인 메시지로 git commit을 생성하세요** (예: "Complete Phase 5: Chat interface implementation")
...
**중요**: 작업 또는 단계를 완료한 후 항상 [TODO.md](TODO.md)에 현재 진행 상황을 업데이트하세요.
